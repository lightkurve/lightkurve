...
class TargetPixelFile(object):
    ...
    def interact(self, notebook_url='localhost:8888', max_cadences=30000,
                startup_aperture=None, exported_filename=None):
        ...
        startup_aperture: np.ndarray
            An aperture mask to start from, applied at the beginning of interact.
            Defaults to the pipeline_mask if available.
        ...
        return show_interact_widget(self, notebook_url=notebook_url,
                                    ...
                                    startup_aperture=startup_aperture,
