...
class TargetPixelFile(object):
    ...
    def interact(self, notebook_url='localhost:8888', max_cadences=30000,
        ...
        aperture_mask: array-like or string
            An aperture mask to be used as the starting mask at the beginning of
            a new .interact() visualization. Defaults to the pipeline mask, and 
            supports 'threshold' defined masks
