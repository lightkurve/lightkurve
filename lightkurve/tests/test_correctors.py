...
def test_design_matrix_aperture_mask():
    ...
    lc_pipeline = PLDCorrector(tpf[:700], design_matrix_aperture_mask='pipeline').correct(robust=True)
    # use all pixels in the tpf
    lc_all = PLDCorrector(tpf[:700], design_matrix_aperture_mask='all').correct(robust=True)
