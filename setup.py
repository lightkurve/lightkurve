...
setup(
    ...
    install_requires=['astropy>=4.1', 'astroquery>=0.3.10', 'beautifulsoup4>=4.6.0', 'bokeh>=1.1', 'fbpca>=1.0', 'matplotlib>=1.5.3', 'memoization>=0.3.1; python_version >= "3.6" and python_version < "4.0"', 'numpy>=1.11', 'oktopus>=0.1.2', 'pandas>=1.1.4', 'patsy>=0.5.0', 'requests>=2.22.0', 'scikit-learn>=0.24.0', 'scipy>=0.19.0', 'tqdm>=4.25.0', 'uncertainties>=3.1.4'],
