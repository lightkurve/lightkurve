...
setup(
    ...
    extras_require={"dev": ["black==20.*,>=20.8.0.b1", "flake8==3.*,>=3.8.4", "ghp-import==1.*,>=1.0.1", "isort>=5.6.4; python_version >= \"3.6\" and python_version < \"4.0\"", "jupyter==1.*,>=1.0.0", "jupyterlab==2.*,>=2.0.0", "line-profiler==3.*,>=3.1.0", "memory-profiler==0.*,>=0.58.0", "mypy==0.*,>=0.790.0", "nbsphinx==0.*,>=0.8.0", "numpydoc==1.*,>=1.1.0", "pydata-sphinx-theme==0.*,>=0.4.1", "pylint==2.*,>=2.6.0", "pytest==6.*,>=6.1.2", "pytest-cov==2.*,>=2.10.1", "pytest-doctestplus==0.*,>=0.8.0", "pytest-remotedata==0.*,>=0.3.2", "pytest-xdist==2.*,>=2.1.0", "sphinx==3.*,>=3.3.1", "sphinx-automodapi==0.*,>=0.13.0", "sphinxcontrib-rawfiles==0.*,>=0.1.1"]},
)
