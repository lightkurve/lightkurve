...
class KeplerTargetPixelFile(TargetPixelFile):
    ...
    **kwargs : dict
	...
	def estimate_contamination(self,
		...
		Estimates the fraction flux in the aperture that comes from the target source.
...
class TessTargetPixelFile(TargetPixelFile):
	...
	def estimate_contamination(self,
		...
		# TessPRF = self.prf
		# prf_model = TessPRF.prf_model(center_row = catalog['row'], center_col = catalog['column'], 
		#		scale=scale, rotation_angle=rotation_angle, )
		# return self.estimate_contamination(prf_model, aperture = aperture, catalog['flux'])
