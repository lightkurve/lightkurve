...
def test_to_fits():
    ...
    lc_generic = io.generic.read_generic_lightcurve(time_column="time", flux_column="flux")
    assert 'quality' is not in lc_generic.columns
    assert 'sap_quality' is not in lc_generic.columns
